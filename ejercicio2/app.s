...
main:
    ...
    //---------------------------------------------------------
/*    bl nube
    mov     x25, #100          // x inicial
	mov     x26, #350          // y inicial
	mov     x27, x20           // framebuffer base
    bl draw_sonic */
...
draw_sonic:
       /* mov x25, x18 //guardo el x inicial
        mov x26, x16 //guardo el y inicial
        mov x27, x17 //guardo el frame buffer */
    stp x29, x30, [sp, #-16]!   
    mov x29, sp                 
        //      picos
            //      pico 1
